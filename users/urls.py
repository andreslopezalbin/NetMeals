...
from users.views.GuestViews import EditProfile, view_profile
...
urlpatterns = [
    ...
    url(r'^profile', view_profile, name='profile_edit'),
    url(r'^profile/edit$', EditProfile.as_view(), name='profile_edit'),
]
